...
const { publishOrderPlaced } = require('../events/kafkaProducer');
...
exports.createOrder = async (req, res) => {
  ...
  try {
    ...
    // Fire the event after the order is confirmed — downstream consumers
    // (ai-service) build "customers also bought" data from this.
